...
import rfantibody.rfdiffusion.rotation_conversions
...
import rfantibody.rfdiffusion.igso3
import time 
...
class IGSO3():
    ...
    def reverse_sample_vectorized(self, R_t, R_0, t, noise_level, mask=None, return_perturb=False, rotation_scaling=None):
        ...
        Perturb = rfantibody.rfdiffusion.rotation_conversions.axis_angle_to_matrix(Perturb_rotvec)
        if return_perturb :
            return Perturb
